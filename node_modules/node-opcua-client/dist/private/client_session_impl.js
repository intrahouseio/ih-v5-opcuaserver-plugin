...
class ClientSessionImpl extends events_1.EventEmitter {
    ...
    performMessageTransaction(request, callback) {
        ...
        if (request instanceof node_opcua_service_subscription_1.PublishRequest || request instanceof node_opcua_types_1.ActivateSessionRequest || request instanceof node_opcua_types_1.CloseSessionRequest) {
