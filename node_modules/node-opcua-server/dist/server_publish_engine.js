...
class ServerSidePublishEngine extends events_1.EventEmitter {
    ...
    findLateSubscriptionsSortedByAge() {
        ...
        late_subscriptions = lodash_1.sortBy(late_subscriptions, "timeToExpiration");
    ...
    send_keep_alive_response(subscriptionId, future_sequence_number) {
        ...
        if (this.pendingPublishRequestCount === 0 || subscription.hasPendingNotifications) {
            ...
            traceLog("send_keep_alive_response  => cannot send keep-aliave  (no PublishRequest left) subscriptionId = ", subscriptionId);
            return false;
        }
    ...
    _cancelTimeoutRequests() {
        ...
        const parts = lodash_1.partition(this._publish_request_queue, timeout_filter);
