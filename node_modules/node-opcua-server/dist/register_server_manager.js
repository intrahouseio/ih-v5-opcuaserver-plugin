...
class RegisterServerManager extends events_1.EventEmitter {
    ...
    _establish_initial_connection(outer_callback) {
        ...
        registrationClient.on("backoff", (nbRetry, delay) => {
            ...
            warningLog(chalk_1.default.bgWhite.cyan("contacting discovery server backoff "), this.discoveryServerEndpointUrl, " attempt #", nbRetry, " retrying in ", delay / 1000.0, " seconds");
