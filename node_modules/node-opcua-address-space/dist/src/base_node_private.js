...
function _clone_children_on_template(nodeToClone, newParent, node, copyAlsoModellingRules, optionalFilter, extraInfo) {
    ...
    doTrace &&
        traceLog(extraInfo === null || extraInfo === void 0 ? void 0 : extraInfo.pad(), chalk_1.default.gray("-------------------- now cloning children on template ", node.browseName.toString(), node.nodeId.toString(), nodeToCloneTypeDefinition.browseName.toString()));
    ...
    while (typeDefinitionNode) {
        // istanbul ignore next
        doTrace &&
            traceLog(extraInfo === null || extraInfo === void 0 ? void 0 : extraInfo.pad(), chalk_1.default.green("-------------------- now cloning children on ", newParentChild.browseName.toString(), newParentChild.nodeId.toString(), " (child of ", node.browseName.toString(), node.nodeId.toString(), ") from ", typeDefinitionNode.browseName.toString()));
...
function _clone_collection_new(nodeToClone, newParent, collectionRef, copyAlsoModellingRules, optionalFilter, extraInfo, browseNameMap) {
    ...
    for (const reference of collectionRef) {
        ...
        if (alreadyCloned) {
            ...
            // istanbul ignore next
            doTrace &&
                traceLog(extraInfo.pad(), "cloning => ", reference.referenceType.toString({ addressSpace }), "=>", (0, node_opcua_address_space_base_1.fullPath2)(node), chalk_1.default.magentaBright((_a = node.typeDefinitionObj) === null || _a === void 0 ? void 0 : _a.browseName.toString()));
            extraInfo.level += 1;
...
function _cloneInterface(nodeToClone, newParent, node, optionalFilter, extraInfo, browseNameMap) {
    // istanbul ignore next
    doTrace &&
        traceLog(extraInfo === null || extraInfo === void 0 ? void 0 : extraInfo.pad(), chalk_1.default.green("-------------------- now cloning interfaces of ", node.browseName.toString(), node.nodeId.toString()));
    extraInfo = extraInfo || new node_opcua_address_space_base_1.CloneHelper();
    ...
    // istanbul ignore next
    doTrace && traceLog(extraInfo === null || extraInfo === void 0 ? void 0 : extraInfo.pad(), chalk_1.default.green("-------------------- interfaces are  ", interfaces.length));
    ...
    if (!options.ignoreChildren) {
        ...
        if (originalNode.nodeClass === node_opcua_data_model_1.NodeClass.Object || originalNode.nodeClass === node_opcua_data_model_1.NodeClass.Variable) {
            ...
            while (typeDefinitionNode) {
                // istanbul ignore next
                doTrace &&
                    traceLog(extraInfo === null || extraInfo === void 0 ? void 0 : extraInfo.pad(), chalk_1.default.blueBright(originalNode.browseName.toString(), "-----> Exploring ", typeDefinitionNode.browseName.toString()));
