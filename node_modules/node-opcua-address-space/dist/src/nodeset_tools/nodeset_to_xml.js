...
function _dumpVariantValue(xw, dataType, value) {
    ...
    switch (dataType) {
        ...
        default:
            errorLog("_dumpVariantValue!! incomplete  dataType=" + dataType + " - v=" + node_opcua_variant_3.DataType[dataType] + "  value = " + value);
        /*
        throw new Error(
...
function _dumpVariantInnerValue(xw, dataType, value) {
    switch (dataType) {
        ...
        case node_opcua_variant_3.DataType.StatusCode:
        default:
            errorLog("_dumpVariantInnerValue incomplete " + value + " " + "DataType=" + dataType + "=" + node_opcua_variant_3.DataType[dataType]);
